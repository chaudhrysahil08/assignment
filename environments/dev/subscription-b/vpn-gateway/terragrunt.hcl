...
dependency "virtual_network" {
  ...
  mock_outputs = {
    gateway_public_ip_id = "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Network/publicIPAddresses/248.27.219.215"
...
inputs = {
  gateway_name        = "vgw-dev-subscription-b"
  gateway_sku         = "VpnGw1"
